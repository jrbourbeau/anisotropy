...
if __name__ == "__main__":
    ...
    for chi2 in chi2list:
        for l in range(1,8):
            ...
            os.system('/home/jbourbeau/anisotropy/mapfunctions/plotFITS.py -n single -v --scale 3 -f fitmaps/fitmap_lmax{}_{}chi2.fits -d -90 -D -25 --outDir /home/jbourbeau/public_html/figures/collaboration-meeting-2016/ --customOut fitmap_{}chi2_lmax{}_dipole -o -b'.format(l,chi2,chi2,l))
