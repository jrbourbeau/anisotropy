...
def maker(sim, batchSize=200):
    ...
    for i in range(njobs):
        ...
        out = outPrefix + 'SimLLH_%s_%s_%s_ztest.hdf5' % (sim, start, end)
        print out
        ...
        ex += ' python %s/MakeLLHFiles_ztest.py %s %s' % (cwd, out, fileList)
