...
# If ONLY performing a charge LDF reconstruction, then only ONE step of Laputop 
# is necessary.
## Note: the "Trigger" parameter must be set to 3 (since its default is 5).
## The parameters are borrowed from 1st step of the March 2012 parameters in 
## "laputop_standard_traysegment.py".
